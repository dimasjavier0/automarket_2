...
class ProfileFunctions {
  ...
  Future<bool> addToInventory({required ProductEntity productEntity}) async {
    final box = Hive.box<ProductEntity>(favoriteBox);
    await box.put(productEntity.id, productEntity);
    return true;
  }
  ...
  Future<List<ProductEntity>> getInventoryProducts() async {
    final box = Hive.box<ProductEntity>(favoriteBox);
  ...
  Future<bool> removeInventory({required ProductEntity productEntity}) async {
    final box = Hive.box<ProductEntity>(favoriteBox);
    await box.delete(productEntity.id);
    return true;
  }

  ValueListenable inventoryListenable() {
    final box = Hive.box<ProductEntity>(favoriteBox);
    return box.listenable();
  }
}
