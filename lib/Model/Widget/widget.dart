...
import 'package:automarket/services/select_image.dart';
...
import 'package:automarket/View/HomeScreen/HomeDetailScreen/detail_screen.dart';
...
class _EmptyScreenState extends State<EmptyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: widget.colors.blackColor,
      appBar: AppBar(
        backgroundColor: widget.colors.blackColor,
        centerTitle: true,
        title: Text(
          ...
          style: widget.textStyle.titleLarge
              .copyWith(color: widget.colors.whiteColor),
        ),
      ),
      body: duplicateContainer(
          ...
          child: Column(
            ...
            children: [
              ElevatedButton(
                  onPressed: () async {
                    final XFile? image = await getImageFromPhone();
                    setState(() {
                      //image_to_upload = File(image!.path);
                    });
                  },
                  child: Text('+ Vender Automovil ')),
              ...
              SizedBox(
                ...
                child: Center(
                  child: Text(
                    widget.content,
                    style: widget.textStyle.bodyNormal
...
class DuplicateTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: Color.fromRGBO(18, 159, 177, 1),
